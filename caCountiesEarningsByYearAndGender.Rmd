...
ListOfFirstNames <- CountyDataWithGender %>% ungroup() %>%
  ...
  # filter(name == "Moises") %>%
  filter(year >= 2016-70,   # filter for persons between 70 and 16 years 'working age' as of 2016
         year <= 2016-16) %>% distinct() %>%
  droplevels()
...
## count how many died per year
## somehow calc the median age
